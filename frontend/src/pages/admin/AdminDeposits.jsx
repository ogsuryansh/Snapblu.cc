                            ...
                            <tbody className="divide-y divide-slate-700">
                                {deposits.map((d) => (
                                    <tr key={d._id} className="hover:bg-slate-700/50">
                                        ...
                                        <td className="px-6 py-4 text-green-400 font-bold whitespace-nowrap">
                                            ${d.amount}
                                        </td>
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            {d.status === 'pending' && <span className="flex items-center gap-1 text-yellow-500 text-xs bg-yellow-500/10 px-2 py-1 rounded w-fit"><Clock size={12} /> Pending</span>}
                                            {d.status === 'approved' && <span className="flex items-center gap-1 text-green-500 text-xs bg-green-500/10 px-2 py-1 rounded w-fit"><Check size={12} /> Approved</span>}
                                            {d.status === 'rejected' && <span className="flex items-center gap-1 text-red-500 text-xs bg-red-500/10 px-2 py-1 rounded w-fit"><X size={12} /> Rejected</span>}
                                        </td>
