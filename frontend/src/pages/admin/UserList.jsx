        ...
        <div className="p-8">
            ...
            <div className="flex justify-between items-center mb-8">
                ...
                <div className="bg-blue-600/20 text-blue-400 border border-blue-600/30 px-4 py-2 rounded-lg text-sm font-medium">
                    {searchQuery ? `Found: ${filteredUsers.length} / ${users.length}` : `Total Users: ${users.length}`}
                </div>
            </div>
            ...
            <div className="mb-6">
                <input
                    ...
                    className="w-full bg-slate-900 border border-slate-600 rounded-lg px-4 py-3 text-white placeholder-slate-400 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
                />
            </div>
